    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        ...
        .cafe-card{border-radius:8px;overflow:hidden;background:#0d0d0d;border:0.5px solid rgba(255,255,255,0.07);cursor:pointer;transition:all 0.35s}
      ...
      <nav>
        ...
        <ul className="nav-links">
          ...
          <li><a href="/cafes" className="active">Cafes</a></li>
